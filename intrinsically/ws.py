...
wv_1 = KeyedVectors.load_word2vec_format('../trained_model/fasttext_vec_1.bin', binary=True)
print('Loaded model 1')

wv_5 = KeyedVectors.load_word2vec_format('../trained_model/fasttext_vec_5.bin', binary=True)
print('Loaded model 5')

wv_25 = KeyedVectors.load_word2vec_format('../trained_model/fasttext_vec_25.bin', binary=True)
print('Loaded model 25')

wv_50 = KeyedVectors.load_word2vec_format('../trained_model/fasttext_vec_50.bin', binary=True)
